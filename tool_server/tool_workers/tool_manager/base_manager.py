...
class ToolManager(object):
    def __init__(self, controller_url_location=None):
        ...
        self.headers = {"User-Agent": "Client"}
    ...
    def init_online_tools(self, controller_url_location=None):
        ...
        miss_tool = []
        for tool in ['RegionAttributeDescription', 'OCR', 'DrawBox', 'Plot', 'AddPoisLayer', 'GetAreaBoundary', 'ChangeDetection', 'Solver', 'SegmentObjectPixels', 'AddText', 'ObjectDetection', 'GoogleSearch', 'BaseModel', 'CountGivenObject', 'Calculator']:
