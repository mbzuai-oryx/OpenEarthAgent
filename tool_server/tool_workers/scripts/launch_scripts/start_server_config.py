...
def main():
    ...
    argparser.add_argument("--config", type=str, default="OpenEarthAgent/tool_server/tool_workers/scripts/launch_scripts/config/all_service_example.yaml", help="Path to configuration file")
